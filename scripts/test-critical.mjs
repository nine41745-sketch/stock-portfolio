...
// v1.27.3 release metadata must stay synchronized across changelog/package/lockfile.
const packageJson = JSON.parse(fs.readFileSync('package.json', 'utf8'))
assert.equal(packageJson.version, '1.27.3', 'Package version must be finalized as v1.27.3 for this release')
...
const changelogReleaseTimes = [
  ...
  ['config/changelog-v1271.ts', '2026-09-16 02:10 ICT'],
...
assert.deepEqual(tsconfig.compilerOptions?.paths?.['@/config/changelog'], ['./config/changelog-v1273'])
