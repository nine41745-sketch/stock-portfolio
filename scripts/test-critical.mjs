...
// v1.20.0 finalized after approved Stock Check Preview smoke.
const packageJson = JSON.parse(fs.readFileSync('package.json', 'utf8'))
assert.equal(packageJson.version, '1.20.0', 'Package version must be finalized as v1.20.0 after Preview smoke')
...
assert.deepEqual(tsconfig.compilerOptions?.paths?.['@/config/changelog'], ['./config/changelog-v120'])
