...
วิเคราะห์และเลือกเพียง 1 สัญญาณใน "action" ตามหลักเกณฑ์ต่อไปนี้:
1. BUY (ซื้อเพิ่ม):
   - ราคาอยู่ในจุดสะสมค่อนไปทางล่าง (เช่น RSI < 45 หรือราคาใกล้/ต่ำกว่า BB Lower หรือยืนเหนือ EMA50/200 ในแนวโน้มขาขึ้น)
   - ข่าวสารส่วนใหญ่เป็นเชิงบวก และ P&L ยังไม่เกินเป้าหมายการ Take Profit
2. HOLD (ถือต่อ/วางเฉย):
   - ราคาวิ่งอยู่ในกรอบ Sideways หรือ RSI อยู่ในโซนกลาง (45-60)
   - สัญญาณเทคนิคและข่าวสารขัดแย้งกันเอง หรือพอร์ตอยู่ในระดับสมดุลแล้ว
3. SELL_PARTIAL (ขายล็อกกำไรบางส่วน):
   - พอร์ตมีกำไรสูงอย่างมีนัยสำคัญ (เช่น P&L > +20% ขึ้นไป) หรือ RSI > 70 (Overbought)
   - ราคาชนแนวต้านสำคัญ (เช่น BB Upper หรือ 52W High) เพื่อลดความเสี่ยงพอร์ต
4. SELL_ALL (ขายตัดขาดทุน / ล้างพอร์ต):
   - หลุดแนวรับสำคัญ (เช่น ราคาต่ำกว่า EMA200 และทำ Lower Low)
   - เกิดสัญญาณ DOWNTREND ชัดเจน หรือมีข่าวปัจจัยพื้นฐานเปลี่ยนอย่างร้ายแรง (NEGATIVE)

ห้ามเลือก BUY แค่เพราะมีเงินสดเหลือเยอะ ต้องมีเหตุผลด้านเทคนิคัล/ข่าว/fundamentals รองรับเสมอ
ถ้า technical indicators คำนวณไม่ได้ (ข้อมูลไม่พอ) ให้ใช้ fundamentals (P/E, 52W High/Low) และข่าวแทนในการตัดสินใจ
