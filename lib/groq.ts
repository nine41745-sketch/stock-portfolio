...
2. SELL_PARTIAL (ขายล็อกกำไรบางส่วน):
   - P&L เกิน +20% ขึ้นไป หรือ RSI(14) รายวัน > 70 (Overbought) — ถ้า RSI(14) รายสัปดาห์ overbought ร่วมด้วย (>70) ยิ่งมั่นใจว่าใกล้จุดพีคจริง ไม่ใช่แค่ noise ระยะสั้น
...
3. BUY (ซื้อเพิ่ม):
   - แนวโน้มเป็น UPTREND หรือ RSI(14) รายวัน < 45 (โซนสะสม) หรือราคาใกล้/ต่ำกว่าแนวรับ (Support)
   - ถ้า RSI(14) รายสัปดาห์ยังไม่ oversold (ยังสูงกว่า 45) ระหว่างที่ RSI รายวัน oversold — แปลว่าเป็นแค่การย่อตัวระยะสั้นในเทรนด์ใหญ่ที่ยังแข็งแรง เป็นสัญญาณซื้อที่น่าเชื่อถือกว่า แต่ถ้า RSI รายสัปดาห์ก็ oversold ด้วย ให้ระวังว่าอาจเป็นเทรนด์ขาลงใหญ่ ไม่ใช่แค่ย่อตัว
   - ข่าวสารส่วนใหญ่เป็นเชิงบวกหรือเป็นกลาง และยังไม่เข้าเกณฑ์ SELL_PARTIAL ข้างต้น และไม่ใกล้ประกาศงบภายใน 7 วัน
4. HOLD (ถือต่อ) — ใช้เฉพาะเมื่อไม่เข้าเกณฑ์ 1-3 ข้างต้นเลยจริงๆ เท่านั้น เช่น RSI(14) รายวัน อยู่กลางแท้ๆ (45-60) และ P&L อยู่ระหว่าง -15% ถึง +20% และไม่มีข่าวสำคัญ

หมายเหตุการใช้ RSI คู่ (รายวัน/รายสัปดาห์): เกณฑ์ RSI ด้านบนทั้งหมดอ้างอิงจาก RSI(14) รายวันเป็นตัวกระตุ้นสัญญาณหลัก (short-term trigger)
ส่วน RSI(14) รายสัปดาห์ใช้เป็นตัวยืนยันภาพใหญ่ (confirmation) เท่านั้น ไม่ใช่ตัวกระตุ้นสัญญาณเอง — ใช้เพิ่ม/ลดความมั่นใจในสัญญาณที่ได้จากรายวันตามที่อธิบายไว้ในแต่ละเกณฑ์ข้างต้น
